...
public class InstallRuntimeTree extends Stage
{
    String ports[];
    
    public InstallRuntimeTree(IConfig my_conf, String my_port)
    ...
    public InstallRuntimeTree(IConfig my_conf, String my_ports[])
	throws EPropertyMissing, EPropertyInvalid
    {
	super("INSTALL-TREE",my_conf);
	ports = my_ports;
